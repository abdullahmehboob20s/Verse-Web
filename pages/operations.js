            ...
            >
              <div className="lg:py-50px">
                <h4 className="fs-24px text-white font-semibold mb-4">
                  ...
                  development of our network and its tools must be purpose
                  driven. The best way to know what will be needed by a live
                  user-base is to operate a live system throughout the
                  development process.
                </h4>

                <p className="fs-16px text-white font-light">
                  In keeping with that principle, we have provided users with
                  two generations of virtual world software, and will soon begin
                  beta testing the third-generation of software. The knowledge
                  and understanding gained in the 17 years of operating history
                  are priceless, and they have led to the development of the new
