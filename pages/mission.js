    ...
    <div>
      ...
      <div className="mb-150px">
        <TwoColumnsSection img="images/mission-2.png" reverse={true}>
          ...
          <p className="fs-18px text-white font-medium mb-6">
            The Utherverse is not just “a” metaverse. It is the next generation
            of the Internet: a decentralized multiverse, led by a new and
            abundant generation of creators, that is set to deliver
            interconnected, immersive experiences.
          </p>

          <p className="fs-16px text-white">
            The foresight and vision of our founder Brian Shuster has put the
            Utherverse in a key position as a hub around which other visions of
            the metaverse will eventually coalesce, interoperate, and cross
            pollinate.
          </p>
        </TwoColumnsSection>
      </div>
          ...
          <div className="max-w-[40rem] mx-auto space-y-6">
            <Accordion title="Patents on Critical Technology">
              <div className="space-y-4">
                ...
                <p className="fs-16px text-white font-medium">
                  ...
                  already included massive technological breakthroughs that have
                  DOZENS OF PATENTS on critical technological processes and
                  methods necessary to operate a “metaverse”.
                </p>
                <p className="fs-16px text-white font-medium">
                  We are the only platform that can truly handle MMOR ™ (Massive
                  Multiuser Online Reality) scenarios on all devices, without a
                  massive drain on network resources and with a Permissions tech
                  stack that facilitates interoperability between worlds and
                  exchange of goods safely and efficiently.
                </p>
              </div>
            </Accordion>
            <Accordion title="3rd Generation Platform">
              <div className="space-y-4">
                ...
                <p className="fs-16px text-white font-medium">
                  It is designed to package the best of video games, VR and the
                  Internet into an open, community based massive global web of
                  interconnected metaverse worlds. With more than $40 million
                  invested in development thus far, more than 17 years of
                  experience, a massive existing user base and our incredible
                  intellectual property portfolio, we plan to be the dominant
                  company offering the genuine metaverse within 18 months of
                  release.
                </p>
              </div>
            </Accordion>
            <Accordion title="AAA+ Development Team">
              <div className="space-y-4">
                <p className="fs-16px text-white font-bold">
                  Our development team is a seasoned group of visionaries, with
                  countless game titles under their belts. They have already
                  built and rebuilt multiple iterations of the Utherverse in
                  preparation for our newest platform.
                </p>
                <p className="fs-16px text-white font-medium">
                  Legacy worlds built by Utherverse still host an active and
                  dedicated user base. At their peak, millions of monthly users
                  called Utherverse operated worlds, home.
                </p>
              </div>
            </Accordion>
            <Accordion title="The Utherverse is a co-creative endeavor!">
              <div className="space-y-4">
                <p className="fs-16px text-white font-bold">
                  We are an open platform. As such, we will build and evolve our
                  world together with the communities of the Internet. We give
                  each of our users the chance to thrive and succeed, while
                  helping to build the best space for everyone.
                </p>
            ...
            <Accordion title="Reverse Damage done by Web 2.0">
              <div className="space-y-4">
                <p className="fs-16px text-white font-bold">
                  ...
                  in the future. The metaverse will not simply be a place we go
                  into. The metaverse will be everywhere around us.
                </p>
              </div>
            </Accordion>
            <Accordion title="A Revolution in Virtual Reality">
              <div className="space-y-4">
                <p className="fs-16px text-white font-bold">
                  ...
                  commercial platform which will include all of the openness and
                  features that we’ve been developing and refining for more than
                  a decade.
                </p>
