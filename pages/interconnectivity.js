  ...
  return (
    <div className="bg-page">
      <div className="z-10">
        ...
        <div className="pt-10 sm:pt-14 lg:pt-100px pb-100px relative mb-0px z-20">
          <div className="container">
            <div className="w-full max-w-[60rem] mx-auto">
              ...
              <h4 className="text-purple fs-24px font-semibold text-center mb-6">
                The Utherverse is designed to be a constellation of virtual
                worlds and metaverse offerings, each of which is run by a
                Sovereign operator that is licensed but independent from
                Utherverse.
              </h4>

              <p className="text-center text-white font-light">
                Each sovereign metaverse has broad authority to set the rules
                and policies that will govern the community in that particular
                region, customize features, look and feel, graphical displays
                and even the user interface that will enable a vast array of
                unique and charmingly different experiences
              </p>
            </div>
          </div>
          ...
          <div className="container-2">
            <div className="w-full max-w-[50rem] mx-auto mb-16">
              ...
              <h2 className="fs-24px text-purple font-medium text-center leading-[1.3] mb-5 md:mb-8">
                Virtual worlds, which are analogous to webpages on the
                traditional Internet, span a number of different categories,
              </h2>
