      ...
      <div className="mb-100px">
        <TwoColumnsSection img="images/web3d-img-1.png" reverse={true}>
          ...
          <p className="fs-16px text-white">
            ...
            users being in a real-world space or dealing with 3D objects such as
            real-estate, interior design and shopping, will all realize huge
      ...
      <div className="mb-100px">
        <TwoColumnsSection img="images/web3d-img-2.png">
          ...
          <p className="fs-16px text-white mb-6">
            ...
            with complex back-end coding to integrate Web 2.0 features into our
            AEON Web3.D browser: video, audio, graphics, animations, textures,
            props, sounds, movement scripts, HTML5-enabled visuals; and
            e-commerce capabilities.
          </p>
          <p className="fs-16px text-white">
            Users are guided to any one of the metaverse worlds by hyperlinking
            on a unique URL in the AEON browser, or they can search for worlds
            by topic using search directories similar to web 2.0
          </p>
        </TwoColumnsSection>
      </div>
