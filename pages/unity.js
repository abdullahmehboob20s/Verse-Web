          ...
          >
            <div>
              ...
              <p className="fs-16px text-white font-light">
                From the beginning, Utherverse has been a complement to the
                Unity 3D game development system. Our creators chose Unity as
                the foundation on which to build the Utherverse because it is
                cross-platform, powerful, feature-rich, and has a thriving
                developer community already familiar with its art asset
                pipeline.
              </p>
            </div>
          </TwoColumnsSection>
          ...
          <TwoColumnsSection img="images/uinty-img-1.png">
            <div>
              ...
              <h4 className="fs-24px text-purple font-semibold mb-6">
                The proprietary technological breakthroughs by Utherverse now
                make all of this possible in a massively multi-user online
                environment.
              </h4>
              ...
              <p className="fs-16px text-white mb-5 font-light">
                ...
                textures, props, sounds, movement scripts, HTML5-enabled
                visuals; and e-commerce capabilities.
              </p>
              <p className="fs-16px text-white font-light">
                Users are guided to any one of the metaverse worlds by
                hyperlinking on a unique URL in the AEON browser, or they can
                search for worlds by topic using search directories similar to
                web 2.0
              </p>
            </div>
          </TwoColumnsSection>
          ...
          <TwoColumnsSection img="images/unity-img-2.png" reverse={true}>
            <div>
              ...
              <h4 className="fs-24px text-purple font-semibold mb-6">
                ...
                software as the rest of the car. Together you get a full ride,
                and with Utherverse and Unity, it’s the ride of your dreams!
              </h4>

              <p className="fs-16px text-white font-light">
                Game engines (ex: Unity, Unreal, Source, etc.) are little more
                than a set of code libraries, presented in an integrated
                development environment used to render 3D spaces, special
