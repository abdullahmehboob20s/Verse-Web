      ...
      <div className="mb-100px">
        ...
        >
          ...
          <p className="fs-16px text-white mb-6">
            The dominant metaverse can be an open and uplifting one; or it could
            be a closed, algorithmically oppressing one that is driven by
            profits over people.
          </p>
      ...
      <div className="mb-150px">
        <TwoColumnsSection img="images/vission-banner-2.png">
          ...
          <p className="fs-24px text-purple mb-6">
            It is the purpose and intention of Utherverse, to create a new kind
            of human interaction within in a 3D environment.
          </p>

          <p className="fs-16px text-white">
            It provides access to the highest quality entertainment, education,
            and business opportunities, while offering rewarding social
            experiences that will be available to every person, anywhere in the
            world. Utherverse is driven to undo the harm of Web 2.0 social media
            companies by providing a new kind of honest and heartfelt socially
            interactive experience that will unite people globally, so that they
            can meet, interact, learn, benefit, work, and play together without
