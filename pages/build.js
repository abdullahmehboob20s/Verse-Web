      ...
      <div className="z-10">
        ...
        <div className="mb-20 lg:mb-100px">
          ...
          >
            <div className="lg:py-8">
              ...
              <p className="fs-16px text-white mb-6">
                As a Sovereign, you own your own metaverse, hosted on our
                platform and interconnected to a whole constellation of virtual
                worlds. Your fans, followers and customers go straight to your
                metaverse; but you also earn royalties from everything they do
                anywhere they go on the entire network.
              </p>
        ...
        <div className="mb-20 lg:mb-100px">
          <TwoColumnsSection img="images/build-img-2.png">
            ...
            <p className="fs-24px text-purple font-bold mb-6 leading-[1.2]">
              You’ll be able to bring businesses and players into your world.
              You can hold your own events and sell your own virtual real
              estate, NFTs and offerings using our advanced platform tools and
              our proven business models.
            </p>

            <p className="fs-16px text-white mb-6">
              Using the power of the Utherverse, you can quickly tilt up your
              own Sovereign Metaverse! We can use your existing artwork or
              assets; you can have your own team build for you; or you can have
              us build out your metaverse.
            </p>
            <p className="fs-16px text-white">
              Your ideas, your design, your taste, your fans, your designer,
              your content, your partners and your brands can all be brought
              into the metaverse together, using our platform and tools.
            </p>
          </TwoColumnsSection>
        </div>
          ...
          >
            <div className="lg:py-8">
              <div className="mb-50px">
                ...
                <p className="fs-16px text-white">
                  All of our metaverse offerings are networked and
                  interoperable, allowing users the ability to carry their
                  profiles and secure metawallets from one virtual world to the
                  next.
                </p>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-10">
              <FixedHeightCard bg="bg-purple-gradient-2" title="Our Network">
                <p className="fs-16px text-white font-medium">
                  By being a part of our network, you’ll have instant access to
                  a huge base of users that will find your world, services and
                  ...
                  can’t do if you have a stand-alone offering. Businesses will
                  get listed on the first and only metaverse search engine,
                  where users of the Utherverse go to find locations to visit
                  and to Landmark. That’s built-in exposure for any offering you
                  want to launch.
                </p>
              </FixedHeightCard>
              <FixedHeightCard
