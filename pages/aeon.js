  ...
  return (
    <div className="bg-page">
      <div>
        ...
        <div className="py-12 md:py-20 lg:py-100px relative mb-50px z-20">
            ...
            <div className="grid lg:grid-cols-2">
              <FixedHeightCard title="A Virtual Constellation">
                <p className="fs-16px text-white font-medium">
                  Other companies billing their VR spaces as “the metaverse”
                  will be the equivalent of websites, while you can think of the
            ...
            <div>
              <div className="mb-10">
                ...
                <p className="fs-24px text-purple leading-[1.2] font-semibold mb-4">
                  ...
                  jump from location to location, search the metaverse and give
                  a suite of tools similar to what you would find in a flat-web
                  browser updated for the metaverse.
                </p>

                <p className="text-sm text-white font-light">
                  Aeon is a web 3.D browser with powerful new search engine
                  tools, where you can:
                </p>
              </div>
        ...
        <div className="mb-20 lg:mb-100px">
          <div className="py-100px lg:py-150px xl:py-200px relative z-20">
            <div className="container-2">
