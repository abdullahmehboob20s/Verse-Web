        ...
        <div className="mb-20 lg:mb-100px">
          <TwoColumnsSection img="images/vww-img-1.png" reverse={true}>
            ...
            <p className="fs-16px text-white">
              ...
              secure and flexible internet infrastructure ever designed,
              utilizing breakout browser technology (Aeon™) that enables surfing
              the web in 3D, virtual reality and augmented reality, all while
              retaining traditional flat-web browsing capabilities.
            </p>
          </TwoColumnsSection>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-10">
              <FixedHeightCard title="Expanding the Value of the Internet">
                <p className="fs-16px text-white font-medium">
                  ...
                  business segments, such as real-estate, conventions,
                  education, large-scale meetups and live entertainment, as well
                  as thousands of smaller market opportunities were left
                  unfulfilled by the prior internet iteration.
                </p>
              </FixedHeightCard>
              <FixedHeightCard title="A Unified Platform">
                <p className="fs-16px text-white font-medium">
                  ...
                  interact in new, unlimited real and unreal ways. Technology
                  and experience are compelling today, and they are designed to
                  adapt to the foreseeable and imminent virtual reality
          ...
          >
            <div className="lg:py-7">
              ...
              <p className="fs-24px text-purple font-bold mb-6 leading-[1.3]">
                ...
                innovation that it is impossible to overstate the potential
                impact on all private and public institutions and individuals.
              </p>
              ...
              <p className="fs-16px text-white">
                ...
                vision of democratizing game development and expands it from
                just games to encompass all forms of social VR development.
              </p>
            </div>
          </TwoColumnsSection>
        </div>
          ...
          <TwoColumnsSection img="images/vww-img-3.png" imgHeight="h-full">
            <div className="lg:py-7">
              ...
              <p className="fs-16px text-white mb-6">
                ...
                multi-player experiences that can be as unique as their
                creators; including online games, entertainment venues, social
                networks, educational environments, services and shopping or
                even architectural visualizations.
              </p>
              <p className="fs-16px text-white mb-6">
                Because the VWW is a system that operates both the platform and
                the browser, files and downloads are managed in extraordinary
                ways that result in efficiencies and better end-user
                experiences.
              </p>
              <p className="fs-24px text-purple font-bold leading-[1.3]">
                The Utherverse system is a software platform for building and
                presenting engaging virtual experiences. As such, it isn’t
                purpose built to do specific things like online banking or
                providing news; but rather as a protocol to enable the rapid
                creation of any imaginable type of elaborate virtual reality
                offerings.
              </p>
            </div>
          </TwoColumnsSection>
