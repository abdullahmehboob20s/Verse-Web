  ...
  return (
    <nav className="fixed bg-black z-50 top-0 left-0 w-full border-b-[1px] border-purple">
      <div className="container-2 h-[3.4rem] lg:h-auto lg:py-[1rem] xl:py-[1.4rem] flex justify-end lg:justify-[unset] items-center relative space-x-6">
        ...
        <div
          ref={sidebarRef}
          className={`flex flex-col lg:flex-row lg:items-center justify-between flex-1 fixed top-0 right-0 lg:static border-l-1 border-purple lg:border-none w-[300px] min-h-screen lg:h-auto lg:w-auto bg-black p-12 lg:p-0 overflow-y-auto lg:overflow-visible transition-all duration-[.3s] lg:translate-x-0 z-[120] ${
