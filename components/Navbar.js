...
function Navbar() {
  return (
    <nav className="border-b-[1px] border-purple">
      <div className="container-2 py-[1.2rem] flex items-center relative space-x-6">
        <Link href="/">
          <a className="w-[12rem] flex items-center justify-center ml-[-8%] mb-[-8%] bg-black">
